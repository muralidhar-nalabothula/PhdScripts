...
def main():
    ...
    two_ph_raman = two_ph_raman.transpose(0,2,1,3,4,5,6) #(1, 3, 2304, 9, 9, 3, 3),
    print(two_ph_raman.shape)
    freq_ram = data['2ph_ph_freq_cm-1'].transpose(1,0,2,3)
    ...
    freq_fine = interp_freq(qpoints_fine).transpose(1,0,2,3)

    two_ph_raman_fine = np.moveaxis(tpr_fine, 0, 1)
    two_ph_raman_fine = two_ph_raman_fine.transpose(0,2,1,3,4,5,6) #(1, 3, 2304, 9, 9, 3, 3),
