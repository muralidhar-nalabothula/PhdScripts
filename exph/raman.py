    ...
    for iq in range(nq):
        ...
        for il in range(n_modes):  # First phonon
            for jl in range(n_modes):  # Second phonon
                ...
                # ==============================================================================
                # for AA and EE, if q = -q and l = m, we have 2 same sets of 4 terms
                degen_fac = 1.0
                if (iq == minus_iq_idx and il == jl): degen_fac = 0.5
                #
                ph_sum_aa = ph_freq_mq[jl] + ph_freq_q[il]
                ram_fac = degen_fac*np.sqrt(
...
def test_compute_raman_twoph():
    ...
    ref_res =np.array([
        [0.02370519-0.0606795j,  0.0595814-0.05695087j, 0.06482968-0.08883329j,
         0.01997198-0.01840819j, 0.01732709-0.01284454j, 0.01107977-0.0134547j,
         0.0062875-0.00994134j, 0.01038468-0.04452347j, 0.06482968-0.08883329j,
         0.05815613-0.06474335j, 0.01741703-0.01513064j, 0.04629167-0.09888207j,
         0.00795517-0.00481848j, 0.04557751-0.08544062j, 0.02319235-0.06093612j,
         0.01117465-0.01165123j],
        [0.04298482+0.04175829j, 0.01337865+0.00415358j, 0.02373522+0.00074705j,
         0.01222663+0.00094123j, 0.07926921+0.03226187j, 0.04352852+0.0198752j,
         0.00934234+0.00156097j, 0.09658909+0.05992155j, 0.03858684+0.03229266j,
         0.08048352+0.04000037j, 0.0215035+0.0213518j,  0.0713391+0.05482515j,
         0.00934234+0.00156097j, 0.01613142+0.00695626j, 0.02745707+0.01531404j,
