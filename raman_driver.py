...
broading = 0.01 # in eV
npol = 2
modes = [58, 71, 72] #[121,122,123,124] # in empty all modes are computed, indexing start with 1
...
ele_dips = get_dipoles(bs_bands, nvalance_bnds, dip_file=dipole_file,var='DIP_v')
...
if Raman:
    ...
    np.savetxt('Raman_intensities.dat',np.concatenate((ome_range[:,None], raman_inte),axis=1))
